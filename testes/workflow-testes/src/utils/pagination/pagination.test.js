...
test('pagination({total: "abc", activePage: 1}) should return trhow an error', () => {
    const params = { total: "abc", activePage: 1 };
    const result = 'Total deve ser numero';
    try {
        pagination(params)
    } catch (e) {
...
test('pagination({total: 10, activePage: "1a"}) should return trhow an error', () => {
